...
In the treadmill hallway room, take the left or right, it doesn’t matter. You will encounter Vulkin in the middle-ish of the room. FIGHT Vulkin and land a semi-accurate hit on them to one-hit kill them. Go up after the encounter and exit through the top exit.
...
Inside the Hotel, go up and left around the fountain. Exit through the exit at the top of the room. If you *really* need heals for Sans, grab some at Burgerpants’s shop before leaving the hotel.
...
You will need to get 35 kills in the Core. Note that Core saves a kill counter with Hotland for a total of 40 kills, but since you'll always start Core at 5 kills, many runners choose to count the 35 Core kills separately and so that is the convention used by this guide.
